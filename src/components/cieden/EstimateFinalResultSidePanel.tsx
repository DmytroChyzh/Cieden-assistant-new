...
import { X, Sparkles, Clock3, Layers3, Search, LayoutTemplate, Palette, Component, Wand2, FlaskConical, PackageCheck, MessagesSquare } from "lucide-react";
    ...
    >
      <div className="flex items-center justify-between px-5 py-3 shrink-0 bg-white/[0.03] backdrop-blur-sm border-b border-white/[0.08]">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-white/90">Estimate result</h2>
        </div>
