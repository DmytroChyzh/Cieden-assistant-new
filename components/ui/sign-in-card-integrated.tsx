...
export function SignInCardIntegrated() {
  ...
  // For subtle 3D card effect - reduced rotation values
  const mouseX = useMotionValue(0);
  const mouseY = useMotionValue(0);
  const rotateX = useTransform(mouseY, [-300, 300], [1, -1]); // Further reduced for minimal effect
  const rotateY = useTransform(mouseX, [-300, 300], [-1, 1]); // Further reduced for minimal effect
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    // Validate cieden email domain
    if (!email.endsWith("@cieden.com")) {
      setError("Only cieden.com email addresses are allowed");
      setIsLoading(false);
      return;
    }
    ...
    try {
      ...
      if (error instanceof Error && error.message?.includes("cieden.com")) {
        setError("Only cieden.com email addresses are allowed");
      } else {
    ...
    <div className="min-h-screen w-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      >
        <motion.div
          ...
          whileHover={{ z: 2 }} // Minimal z-axis movement
        >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <motion.div className="space-y-3">
                  ...
                  <motion.div 
                    ...
                    whileFocus={{ scale: 1.01 }} // Reduced from 1.02
                  ...
                  >
                    <div className="relative flex items-center overflow-hidden rounded-lg">
                      ...
                      <Input
                        type="email"
                        placeholder="Email (must be @cieden.com)"
                        value={email}
